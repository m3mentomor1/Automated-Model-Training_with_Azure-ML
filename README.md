...
- On **Schema**, verify the data **Type** of each column in the dataset and modify the columns you want to include. (***Note:** For this project, we'll leave the configured data types as is and include all columns.*)<br><br>
- On **Review**, verify that every information shown matches what was previously configured for your data asset. After everything is verified, click ``Create``<br><br>
